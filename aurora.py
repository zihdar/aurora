...
print("Product Count per Customer Type (Pivot Table):")
st.dataframe(product_customer_pivot)
...
st.dataframe(average_satisfaction_per_customer_type)
...
st.dataframe(average_satisfaction_per_Salesperson)
